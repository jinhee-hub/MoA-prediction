...
class TabNetRegressor(TabModel):
    ...
    def train_epoch(self, train_loader):
        ...
        stopping_loss =logLossMulti(ys, torch.sigmoid(torch.as_tensor(y_preds)).numpy()  )
    ...
    def predict_epoch(self, loader):
        ...
        stopping_loss =logLossMulti(ys, torch.sigmoid(torch.as_tensor(y_preds)).numpy()  ) #mean_squared_error(y_true=ys, y_pred=y_preds)
